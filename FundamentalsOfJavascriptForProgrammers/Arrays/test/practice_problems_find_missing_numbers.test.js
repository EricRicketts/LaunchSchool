...
describe('Practice Problems: Find missing numbers', () => {
  it.skip('fills in missing negative numbers', () => {
    const arr = [-3, -2, 1, 5];
    const expected = [-1, 0, 2, 3, 4];
    expect(missing(arr)).toEqual(expected);
  });

  it.skip('returns an empty array if there are no missing numbers', () => {
    const arr = [1, 2, 3, 4];
    expect(missing(arr)).toEqual([]);
  });

  it.skip('returns positive missing numbers', () => {
    const arr = [1, 5];
    const expected = [2, 3, 4];
    expect(missing(arr)).toEqual(expected);
  });

  it.skip('returns empty array for single element array', () => {
